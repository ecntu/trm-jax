...
currently yields this run ([checkpoint](https://huggingface.co/emiliocantuc/trm-vanilla-2)), which displays test-time scaling. After training, we measure % of sudoku puzzles solved (right plot below) as we increase supervision steps $N_\text{sup}$:
